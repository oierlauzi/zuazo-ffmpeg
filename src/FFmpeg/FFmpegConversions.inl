...
constexpr AVColorPrimaries toFFmpeg(ColorPrimaries prim) {
	switch(prim) {
	case ColorPrimaries::BT601_625:		return AVCOL_PRI_BT470BG;
	case ColorPrimaries::BT601_525:		return AVCOL_PRI_SMPTE170M;
...
constexpr ColorPrimaries fromFFmpeg(AVColorPrimaries prim) {
	...
	case AVCOL_PRI_BT470BG:   	return ColorPrimaries::BT601_625;	//also ITU-R BT601-6 625 / ITU-R BT1358 625 / ITU-R BT1700 625 PAL & SECAM
	case AVCOL_PRI_SMPTE170M: 	return ColorPrimaries::BT601_525; 	//also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC
	case AVCOL_PRI_SMPTE240M: 	return ColorPrimaries::BT601_525; 	//functionally identical to above
...
constexpr ColorModel fromFFmpeg(AVColorSpace model) {
	...
	case AVCOL_SPC_SMPTE170M:			return ColorModel::BT601;		//also ITU-R BT601-6 525 / ITU-R BT1358 525 / ITU-R BT1700 NTSC FIXME: Could not find any difference with the above one (525 vs 625)
	case AVCOL_SPC_SMPTE240M:			return ColorModel::BT601;		//functionally identical to above
...
constexpr AVColorTransferCharacteristic toFFmpeg(ColorTransferFunction func) {
	...
	case ColorTransferFunction::BT601:			return AVCOL_TRC_SMPTE170M;
	case ColorTransferFunction::BT709:			return AVCOL_TRC_BT709;
	case ColorTransferFunction::BT2020_10:		return AVCOL_TRC_BT2020_10;
	case ColorTransferFunction::BT2020_12:		return AVCOL_TRC_BT2020_12;
	case ColorTransferFunction::GAMMA22:		return AVCOL_TRC_GAMMA22;
	case ColorTransferFunction::GAMMA28:		return AVCOL_TRC_GAMMA28;
	case ColorTransferFunction::IEC61966_2_1:	return AVCOL_TRC_IEC61966_2_1;
	case ColorTransferFunction::SMPTE2084:		return AVCOL_TRC_SMPTE2084;
	case ColorTransferFunction::ARIB_STD_B67:	return AVCOL_TRC_ARIB_STD_B67;
...
constexpr ColorTransferFunction fromFFmpeg(AVColorTransferCharacteristic func) {
	...
	switch(func) {
    case AVCOL_TRC_BT709:			return ColorTransferFunction::BT709;		//also ITU-R BT1361
    case AVCOL_TRC_GAMMA22:			return ColorTransferFunction::GAMMA22;		//also ITU-R BT470M / ITU-R BT1700 625 PAL & SECAM
    case AVCOL_TRC_GAMMA28:			return ColorTransferFunction::GAMMA28; 		//also ITU-R BT470BG
    case AVCOL_TRC_SMPTE170M:		return ColorTransferFunction::BT601;		//also ITU-R BT601-6 525 or 625 / ITU-R BT1358 525 or 625 / ITU-R BT1700 NTSC
    ...
    case AVCOL_TRC_BT2020_10:		return ColorTransferFunction::BT2020_10; 	//ITU-R BT2020 for 10-bit system
    case AVCOL_TRC_BT2020_12:		return ColorTransferFunction::BT2020_12; 	//ITU-R BT2020 for 12-bit system
    case AVCOL_TRC_SMPTE2084:		return ColorTransferFunction::SMPTE2084; 	//SMPTE ST 2084 for 10-, 12-, 14- and 16-bit systems
    //case AVCOL_TRC_SMPTE428:		return {}; /*NOT SUPPORTED*/ 				//SMPTE ST 428-1
    case AVCOL_TRC_ARIB_STD_B67:	return ColorTransferFunction::ARIB_STD_B67; //ARIB STD-B67, known as "Hybrid log-gamma"
...
constexpr AVPixelFormat toFFmpeg(ColorFormat fmt, ColorSubsampling subs, bool isYCbCr) {
	...
	} else if(subs == ColorSubsampling::RB_444) {
...
constexpr std::tuple<ColorFormat, ColorSubsampling> fromFFmpeg(AVPixelFormat fmt) {
	...
	*/
	...
	case AV_PIX_FMT_YUVA420P:			return { ColorFormat::G8_B8_R8_A8, ColorSubsampling::RB_420 };			//planar YUV 4:2:0, 20bpp, (1 Cr & Cb sample per 2x2 Y & A samples)
	...
	case AV_PIX_FMT_YUVA422P:			return { ColorFormat::G8_B8_R8_A8, ColorSubsampling::RB_422 };			//planar YUV 4:2:2 24bpp, (1 Cr & Cb sample per 2x1 Y & A samples)
	case AV_PIX_FMT_YUVA444P:			return { ColorFormat::G8_B8_R8_A8, ColorSubsampling::RB_444 };			//planar YUV 4:4:4 32bpp, (1 Cr & Cb sample per 1x1 Y & A samples)
	case AV_PIX_FMT_YUVA420P9:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_420 }; //planar YUV 4:2:0 22.5bpp, (1 Cr & Cb sample per 2x2 Y & A samples)
	case AV_PIX_FMT_YUVA422P9:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_422 }; //planar YUV 4:2:2 27bpp, (1 Cr & Cb sample per 2x1 Y & A samples)
	case AV_PIX_FMT_YUVA444P9:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_444 }; //planar YUV 4:4:4 36bpp, (1 Cr & Cb sample per 1x1 Y & A samples)
	case AV_PIX_FMT_YUVA420P10:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_420 }; //planar YUV 4:2:0 25bpp, (1 Cr & Cb sample per 2x2 Y & A samples)
	case AV_PIX_FMT_YUVA422P10:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_422 }; //planar YUV 4:2:2 30bpp, (1 Cr & Cb sample per 2x1 Y & A samples)
	case AV_PIX_FMT_YUVA444P10:			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_444 }; //planar YUV 4:4:4 40bpp, (1 Cr & Cb sample per 1x1 Y & A samples)
	case AV_PIX_FMT_YUVA420P16:			return { ColorFormat::G16_B16_R16_A16, ColorSubsampling::RB_420 };		//planar YUV 4:2:0 40bpp, (1 Cr & Cb sample per 2x2 Y & A samples)
	case AV_PIX_FMT_YUVA422P16:			return { ColorFormat::G16_B16_R16_A16, ColorSubsampling::RB_422 };		//planar YUV 4:2:2 48bpp, (1 Cr & Cb sample per 2x1 Y & A samples)
	case AV_PIX_FMT_YUVA444P16:			return { ColorFormat::G16_B16_R16_A16, ColorSubsampling::RB_444 };		//planar YUV 4:4:4 64bpp, (1 Cr & Cb sample per 1x1 Y & A samples)
	...
	case AV_PIX_FMT_GBRAP:  			return { ColorFormat::G8_B8_R8_A8, ColorSubsampling::RB_444 };			//planar GBRA 4:4:4:4 32bpp
	case AV_PIX_FMT_GBRAP16:  			return { ColorFormat::G16_B16_R16_A16, ColorSubsampling::RB_444 };		//planar GBRA 4:4:4:4 64bpp
	...
	case AV_PIX_FMT_AYUV64:   			return { ColorFormat::A16G16B16R16, ColorSubsampling::RB_444 };			//packed AYUV 4:4:4,64bpp (1 Cr & Cb sample per 1x1 Y & A samples)
	...
	case AV_PIX_FMT_GBRAP12:  			return { ColorFormat::G12X4_B12X4_R12X4_A12X4_16, ColorSubsampling::RB_444 }; //planar GBR 4:4:4:4 48bpp
	case AV_PIX_FMT_GBRAP10:  			return { ColorFormat::G10X6_B10X6_R10X6_A10X6_16, ColorSubsampling::RB_444 }; //planar GBR 4:4:4:4 40bpp
	...
	case AV_PIX_FMT_GBRPF32:  			return { ColorFormat::G32f_B32f_R32f, ColorSubsampling::RB_444 };		//IEEE-754 single precision planar GBR 4:4:4,     96bpp
	case AV_PIX_FMT_GBRAPF32: 			return { ColorFormat::G32f_B32f_R32f_A32f, ColorSubsampling::RB_444 };	//IEEE-754 single precision planar GBRA 4:4:4:4, 128bpp
	...
	case AV_PIX_FMT_YUVA422P12: 		return { ColorFormat::G12X4_B12X4_R12X4_A12X4_16, ColorSubsampling::RB_422 }; //planar YUV 4:2:2,24bpp, (1 Cr & Cb sample per 2x1 Y samples), 12b alpha
	case AV_PIX_FMT_YUVA444P12: 		return { ColorFormat::G12X4_B12X4_R12X4_A12X4_16, ColorSubsampling::RB_444 }; //planar YUV 4:4:4,36bpp, (1 Cr & Cb sample per 1x1 Y samples), 12b alpha
